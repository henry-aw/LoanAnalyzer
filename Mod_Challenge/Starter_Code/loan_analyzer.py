...
print(f"The total number of loans is: {total_number_of_loans}, the total value of the loans is: {total_value_of_loans}, and the average loan amount is: {average_loan_amount}")
